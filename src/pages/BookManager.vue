<template>
  <div>
    ...
    />
    <el-button type="primary" @click="openAddDialog" style="margin-left: 10px; margin-bottom: 16px">
      ➕ 添加图书
    </el-button>
    ...
    <!-- 添加弹窗 -->
    <el-dialog title="添加图书" v-model="addDialogVisible">
    ...
    <!-- 编辑弹窗 -->
    <el-dialog title="编辑图书" v-model="editDialogVisible">
