      ...
      <div class="mx-auto px-4 py-3 container flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          ...
          <ElDropdown @command="handleCommand">
            ...
            <template #dropdown>
              <ElDropdownMenu>
                <ElDropdownItem v-if="!Auth.isAuthenticated" command="login">
                  登录
                </ElDropdownItem>
                <ElDropdownItem v-if="!Auth.isAuthenticated" command="register">
                  注册
                </ElDropdownItem>
                <template v-else>
                  <ElDropdownItem v-if="!Auth.isAdmin" command="profile">
                    个人主页
                  </ElDropdownItem>
                  <ElDropdownItem v-if="!Auth.isAdmin" command="cart">
                    购物车
                  </ElDropdownItem>
                  <ElDropdownItem v-if="Auth.isAdmin" @click="() => router.push('/dashboard')">
                    管理后台
                  </ElDropdownItem>
